...
test('should check array with deadman (JSON.stringify)', () => {
  const friends = [
    { name: 'маг', health: 0 },
...
test('should check big array (JSON.stringify)', () => {
  const friends = [
    { name: 'лучник', health: 80 },
    { name: 'маг', health: 120 },
...
test('should check sort array (toBe)', () => {
  const friends = [
    { name: 'маг', health: 100 },
    { name: 'лучник', health: 80 },
    { name: 'мечник', health: 10 },
...
test('should check sort reverse array (toBe)', () => {
  const friends = [
    { name: 'мечник', health: 10 },
    { name: 'лучник', health: 80 },
    { name: 'маг', health: 100 },
...
test('should check array with repeated (toStrictEqual)', () => {
  const friends = [
    { name: 'лучник', health: 100 },
    { name: 'маг', health: 120 },
    { name: 'кавалерист', health: 200 },
...
test('should check array with same (toStrictEqual)', () => {
  const friends = [
    { name: 'лучник', health: 100 },
    { name: 'маг', health: 100 },
    { name: 'кавалерист', health: 100 },
